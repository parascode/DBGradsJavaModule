...
const person1 = new Person('Vinsys', 'Vinsys')

console.log(person1)
```

```sh
Person {firstName: "Vinsys", lastName: "Vinsys"}
```
...
const person3 = new Person('Abraham', 'Vinsys')
...
Person {firstName: "Abraham", lastName: "Vinsys"}
```
...
const person1 = new Person('Vinsys', 'Vinsys', 250, 'Finland', 'Helsinki')

console.log(person1)
```

```sh
Person {firstName: "Vinsys", lastName: "Vinsys", age: 250, country: "Finland", city: "Helsinki"}
```
...
["Planning", "Managing", "Organizing"]
[]
Vinsys Vinsys is 250. He lives Helsinki, Finland. He knows HTML, CSS and JavaScript
...
const s1 = new Student('Vinsys', 'Vinsys', 'Finland', 250, 'Helsinki')
console.log(s1)
...
```sh
Student {firstName: "Vinsys", lastName: "Vinsys", age: "Finland", country: 250, city: "Helsinki", …}
I am a child of the person class
Vinsys Vinsys
Student {firstName: "Vinsys", lastName: "Vinsys", age: "Finland", country: 250, city: "Helsinki", …}
Vinsys Vinsys is Finland. He lives Helsinki, 250.
```
...
```sh
Student {firstName: "Vinsys", lastName: "Vinsys", age: 250, country: "Finland", city: "Helsinki", …}
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Finland", city: "Helsinki", …}
I am a child of the person class
Vinsys Vinsys
Student {firstName: "Vinsys", lastName: "Vinsys", age: 250, country: "Finland", city: "Helsinki", …}
Vinsys Vinsys is 250. He lives in Helsinki, Finland. He knows HTML, CSS and JavaScript
I am a child of the person class
Lidiya Tekle
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "Finland", city: "Helsinki", …}
...
Check out there result on [codepen](https://codepen.io/Vinsys/full/vYGqQxP)
