...
console.log(
  getUserInfo('Vinsys', 'Vinsys', 'Finland', 'FullStack Developer', skills)
)
```
...
const p1 = new Parent('Vinsys', 'Vinsys', 'Finland', 'FullStack Developer')
