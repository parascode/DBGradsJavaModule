...
```js
Vinsys@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-days-of-react$ npm install react-router-dom
```
...
const challenges = [
  {
    ...
    slug: 'pyhton',
    url:
      'https://github.com/https://https://github.com/Vinsys/30-Days-Of-Python.com/Vinsys/30-Days-Of-JavaScript/30-Days-Of-React',
    author: {
      firstName: 'Vinsys',
      lastName: 'Vinsys',
    },
  },
  {
    ...
    slug: 'javascript',
    url: 'https://github.com/Vinsys/30-Days-Of-JavaScript',
    author: {
      firstName: 'Vinsys',
      lastName: 'Vinsys',
    },
  },
  {
    ...
    slug: 'react',
    url: 'https://github.com/Vinsys/30-Days-Of-React',
    author: {
      firstName: 'Vinsys',
      lastName: 'Vinsys',
    },
