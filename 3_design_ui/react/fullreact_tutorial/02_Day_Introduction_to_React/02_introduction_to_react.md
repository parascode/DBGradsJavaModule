...
[Live on code pen](https://codepen.io/Vinsys/full/QWbGWeY).
...
Now, let us put everything together and render it to the browser. [Live on code pen](https://codepen.io/Vinsys/full/MWwbYWg).
...
Now, lets us apply style the header part only [Live on code pen](https://codepen.io/Vinsys/full/ZEGBYBG).
...
Instead of style object using regular styling method is more easy than the one above. Now, let us use internal style to style all the JSX. It is also possible to use external styling method. [Live on code pen](https://codepen.io/Vinsys/full/QWbGwge)
...
const authorFirstName = 'Vinsys'
const authorLastName = 'Vinsys'
...
const title = 'Getting Started React'
const subtitle = 'JavaScript Library'
const firstName = 'Vinsys'
const lastName = 'Vinsys'
...
Now, let us put everything together. Here, in the example below, the data is injected dynamically to the JSX. [Live on code pen](https://codepen.io/Vinsys/full/YzXWgpZ)
